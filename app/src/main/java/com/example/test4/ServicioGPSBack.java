...
public class ServicioGPSBack extends Service {
            ...
            proveedor_locacion_fusionada.requestLocationUpdates(solicitud_posicion,
                    new LocationCallback() {
                        ...
                        public void onLocationResult(@NonNull LocationResult locationResult) {
                            ...
                            String salida = "u=" + preferencias_compartidas.getInt("clave", 0) + "&c=" + preferencias_compartidas.getString("contraseña", "") + "&la=" + locacion.getLatitude() + "&ln=" + locacion.getLongitude() + "&v=" + velocidad + "&s="+preferencias_compartidas.getString("sucursal", "Mochis");
